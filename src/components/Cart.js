...
const Cart = () => {
  ...
  // Conversion rate (1 USD to LKR)
  const exchangeRate = 300;

  // Function to convert USD to LKR and format
  const toLKR = (usdAmount) => {
                          ...
                          <ul className="divide-y divide-gray-200">
                            {cart.map((item) => (
                              ...
                              >
                                ...
                                <span>
                                  LKR {toLKR(item.price * item.quantity)}
                                </span>
                              </li>
                            ))}
                          </ul>
