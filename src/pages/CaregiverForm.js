                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder=" "
                      />
                      <label className={`absolute left-4 transition-all duration-200 transform ${
                        formData.name 
                          ? '-top-2 text-sm text-blue-600 bg-white px-1'
                          : 'top-3 text-gray-500 peer-focus:-top-2 peer-focus:text-sm peer-focus:text-blue-600 peer-focus:bg-white peer-focus:px-1'
                      }`}>
