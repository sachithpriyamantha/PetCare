      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-blue-100 transition-all hover:shadow-xl">
        <div className="flex space-x-3 mb-4">
          ...
          <textarea
            ...
            className="flex-1 p-3 bg-blue-50 border-0 rounded-xl focus:ring-2 focus:ring-blue-500 resize-none text-gray-700 placeholder-blue-300 min-h-[80px] leading-normal"
            rows={3}
          />
        </div>
              ...
              {editingPost === post._id ? (
                <div className="mb-4">
                  <textarea
                    ...
                    className="w-full p-3 bg-blue-50 border-0 rounded-xl focus:ring-2 focus:ring-blue-500 resize-none text-gray-700 mb-3 min-h-[80px] leading-normal"
                    rows={3}
                  />
